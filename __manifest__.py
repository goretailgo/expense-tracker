...
""",
    ...
    'data': [
        ...
        'views/expense_tracker_monthly_matrix_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            'expense_tracker/static/src/js/monthly_matrix_action.js',
            'expense_tracker/static/src/xml/monthly_matrix_templates.xml',
            'expense_tracker/static/src/css/monthly_matrix.css',
        ],
    },
